  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new ChatScreen(
        ...
        channel: IOWebSocketChannel.connect('ws://192.168.2.13:8000/ws'),
      ),
    );
  }
}
...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen({Key key, @required this.peerId, @required this.peerAvatar, @required this.channel}) : super(key: key);
